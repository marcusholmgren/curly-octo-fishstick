            ...
            <div class="inline-block min-w-full py-2 align-middle">
                <table class="min-w-full border-separate border-spacing-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td
                                class="border-b border-gray-200 py-4 pr-3 pl-4 text-sm font-medium whitespace-nowrap text-gray-900 sm:pl-6 lg:pl-8 dark:border-white/10 dark:text-white"
                            >
                                {contact.first_name}
                            </td>
                            <td
                                class="hidden border-b border-gray-200 px-3 py-4 text-sm whitespace-nowrap text-gray-500 sm:table-cell dark:border-white/10 dark:text-gray-400"
                            >
                                {contact.last_name}
                            </td>
                            <td
                                class="hidden border-b border-gray-200 px-3 py-4 text-sm whitespace-nowrap text-gray-500 lg:table-cell dark:border-white/10 dark:text-gray-400"
                            >
                                {contact.email}
                            </td>
                            <td
                                class="border-b border-gray-200 px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:border-white/10 dark:text-gray-400"
                            >
                                {contact.phone_number}
                            </td>
                            <td
                                class="border-b border-gray-200 py-4 pr-4 pl-3 text-right text-sm font-medium whitespace-nowrap sm:pr-8 lg:pr-8 dark:border-white/10"
                            >
                                <a
                                    href="#"
